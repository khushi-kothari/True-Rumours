  ...
  return (
    <div classNameName="max-w-2xl mx-auto">
      <div className="bg-white shadow-md border border-gray-200 rounded-sm w-72 dark:bg-gray-800 dark:border-gray-700 h-96 mb-4">
        ...
        <div className="p-5">
          <a href="#">
            <h5 className="text-gray-900 font-bold text-lg tracking-tight mb-2 dark:text-white h-20 overflow-clip">
              {/* {article.title} */}
              {title}
            </h5>
          </a>
          <p className="font-normal text-gray-700 mb-3 dark:text-gray-400 overflow-clip truncate h-12">
            {/* {article.abstract} */}
            {desc}
          </p>
          <Link
