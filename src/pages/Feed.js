        ...
        <div className=" block">
          ...
          {news.results ? (
            <div>
              <div>
                {/* Hero Section */}
                <div className="grid grid-cols-5 h-screen mt-10 gap-0 mx-12">
                  <div className="col-span-3 bg-blue-300 h-fit">
                    <img
                  ...
                  <div className=" bg-pink-400 h-fit">
                ...
                {/* Ad Section */}
                <div className="grid grid-cols-5 h-screen mt-10 gap-8 mx-12">
                    ...
                    <div className="grid grid-cols-1 grid-flow-row overflow-scroll">
                      ...
                      <div className="container -mt-36">
                        {isAdActive ? (
                          ...
                          <div className="grid grid-cols-2 grid-flow-row gap-6 overflow-scroll mt-48 mb-20">
                                ...
                                {trending.slice(0, 5).map((t) => (
                                  <div>
                                    ...
                                    <Block
                                      data={t}
                                      img={
                                        t.media[0]?.["media-metadata"].length >
                                        0
